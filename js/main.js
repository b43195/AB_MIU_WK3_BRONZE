...
var changeCats = function(){
	catOps = ["Select One","Friend", "Co-Worker","Family","Frienemy","Aquentence"];
	for(i=0; i<4; i++){
...
var validator = function(eventData){
	...
	valFname.style.border = "2px solid red";
	valLname.style.border = "2px solid red";
	valCat.style.border = "2px solid red";
	valEmail.style.border = "2px solid red";
	window.scrollTo(0,0);
